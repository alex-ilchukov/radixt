...
var (
	blank    = str4.Tree("")
	tooshort = str4.Tree("123")
	empty    = str4.MustCreate(nil)

	atree = str4.MustCreate(
		sapling.New(
			"authority",
			"authorization",
			"author",
...
var treeValueTests = []struct {
	...
	{tree: tooshort, n: 0, result1: 0, result2: false},
	{tree: tooshort, n: 1, result1: 0, result2: false},
	{tree: tooshort, n: 100, result1: 0, result2: false},
...
const testTreeValueError = "Tree Value Test %d: got %d and %t for value " +
...
var treeChunkTests = []struct {
	...
	{tree: tooshort, n: 0, result: ""},
	{tree: tooshort, n: 1, result: ""},
	{tree: tooshort, n: 100, result: ""},
...
const testTreeChunkError = "Tree Chunk Test %d: got '%s' for chunk of " +
	"node %d (should be '%s')"
...
var treeEachChildTests = []struct {
	...
	{tree: tooshort, n: 0, f: eachChild, indices: ""},
	{tree: tooshort, n: 1, f: eachChild, indices: ""},
	{tree: tooshort, n: 100, f: eachChild, indices: ""},
	{tree: tooshort, n: 0, f: eachFirstChild, indices: ""},
	{tree: tooshort, n: 1, f: eachFirstChild, indices: ""},
	{tree: tooshort, n: 100, f: eachFirstChild, indices: ""},
...
var treeHoardTests = []struct {
	...
	{tree: blank, result1: 0, result2: radixt.HoardExactly},
	{tree: tooshort, result1: 3, result2: radixt.HoardExactly},
	{tree: empty, result1: 10, result2: radixt.HoardExactly},
	{tree: atree, result1: 103, result2: radixt.HoardExactly},
}
