...
var tree3ValueTests = []struct {
	...
	{tree: atree3, n: 3, result1: 3, result2: true},
	{tree: atree3, n: 4, result1: 2, result2: true},
	{tree: atree3, n: 5, result1: 7, result2: true},
	{tree: atree3, n: 6, result1: 6, result2: true},
	{tree: atree3, n: 7, result1: 5, result2: true},
...
var tree3ChunkTests = []struct {
	...
	{tree: atree3, n: 3, result: "entication"},
	{tree: atree3, n: 4, result: "or"},
	{tree: atree3, n: 5, result: "disposition"},
	{tree: atree3, n: 6, result: "length"},
	{tree: atree3, n: 7, result: "type"},
...
var tree3EachChildTests = []struct {
	...
	{tree: atree3, n: 3, f: eachChild, indices: ""},
	{tree: atree3, n: 4, f: eachChild, indices: "8"},
	...
	{tree: atree3, n: 3, f: eachFirstChild, indices: ""},
	{tree: atree3, n: 4, f: eachFirstChild, indices: "8"},
...
var tree4ValueTests = []struct {
	...
	{tree: atree4, n: 3, result1: 3, result2: true},
	{tree: atree4, n: 4, result1: 2, result2: true},
	{tree: atree4, n: 5, result1: 7, result2: true},
	{tree: atree4, n: 6, result1: 6, result2: true},
	{tree: atree4, n: 7, result1: 5, result2: true},
...
var tree4ChunkTests = []struct {
	...
	{tree: atree4, n: 3, result: "entication"},
	{tree: atree4, n: 4, result: "or"},
	{tree: atree4, n: 5, result: "disposition"},
	{tree: atree4, n: 6, result: "length"},
	{tree: atree4, n: 7, result: "type"},
...
var tree4EachChildTests = []struct {
	...
	{tree: atree4, n: 3, f: eachChild, indices: ""},
	{tree: atree4, n: 4, f: eachChild, indices: "8"},
	...
	{tree: atree4, n: 3, f: eachFirstChild, indices: ""},
	{tree: atree4, n: 4, f: eachFirstChild, indices: "8"},
